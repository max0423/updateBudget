...
return headerName;
 ...
 // this.getExpenseBalance();
  ...
  layoutSetting(grid)
  {
    var cell  = grid.grid.querySelector('.react-grid-Cell__value');
    cell.style.color = "#EB6C2C";
    cell.style.fontWeight = "bold";

    var nodes = grid.grid.querySelectorAll('.react-grid-Row');
...
updateItem(json) {
 ...
 // axios.post('http://localhost:5001/api/items', json)
  .then(res => {
   console.log("success");})
